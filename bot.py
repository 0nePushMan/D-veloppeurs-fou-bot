...
class MyClient(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.channel.id == 943076081999679518 and message.content.startswith('/s'):
            results = []
        ...
        if message.channel.id == 984434964126904370 and not message.content.startswith('https'):
            ...
            results = requests.get(query, headers={'Authorization': 'Bearer ' + spotify, "Accept": "application/json", "Content-Type": "application/json"}).json()
